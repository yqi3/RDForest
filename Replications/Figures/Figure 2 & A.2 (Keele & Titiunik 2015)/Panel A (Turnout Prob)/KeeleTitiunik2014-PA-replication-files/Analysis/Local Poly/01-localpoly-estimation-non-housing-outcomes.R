...
# Tables 3 and A1 in Keele and Titiunik ("Geographic Boundaries as Regression Discontinuities")
#
######################################
rm(list = ls())
options(width=300)
...
#########################################
# Open main data
data <- read.dta("../../../../Data/NJ/Voter File/Voters_Final.dta",convert.dates = FALSE, convert.factors = FALSE, convert.underscore = FALSE)
dim(data)
names(data)
...
## Approx latitude and longitude for this town: 	lat: 43, long:87
...
#
#########################################
outcomes <- c("e2008g",  "age", "black", "hisp", "dem", "female")
