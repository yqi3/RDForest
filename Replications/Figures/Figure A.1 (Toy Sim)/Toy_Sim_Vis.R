...
# genDGP() is a function that generates a sample from our specified simulation DGP
# Arguments:
#           size: sample size
#           tau: treatment effect in the linear case; default is 0.3
#           beta: coefficients of running var X on the covariates Z
#           delta: coefficients of covariates Z on the outcome Y
