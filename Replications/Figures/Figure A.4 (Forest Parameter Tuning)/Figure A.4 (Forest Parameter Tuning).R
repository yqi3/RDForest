...
# "FigureA.4.csv" collects results from running grf with different scaling constants for subsample fraction using the tuning procedure described in Appendix A.4; the user can replicate these results by running the forest file corresponding to each DGP, with the variable "scale" changed to different values
