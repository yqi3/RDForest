...
for (i in 1:t) {
  ...
  result_bivariate <- append(result_bivariate, prediction)
  ...
  try({print(i)
    ...
    print("----------------")
    print(paste0("Mean of RF:", mean(result_bivariate, na.rm = TRUE)))
    print("----------------")
    print(paste0("Var of RF: ", var(result_bivariate, na.rm = TRUE)))
    print(paste0("Var of RF (BLB): ", variance))
    print("----------------")
    print(paste0("MSE of RF: ", (mean(result_bivariate,na.rm = TRUE)-tau)^2+var(result_bivariate,na.rm = TRUE)))
    print("----------------")
