######################################
# Table A.2.1: Results based on different estimates of the 2nd derivative bound
...
# In section A.2.1 of the paper, the multipliers used are 2, 4, 6, 10, 30
# Please modify the value of the multiplier below to replicate all results
multiplier <- 2
