######################################
# Table 1, Panel G, Columns 1-5: Local Linear Regression for Housing Price
...
data_full <- read.csv("../../../../Data/Keele & Titiunik 2015/WGAN_Epoch1k/price_cWGAN.csv")
focal_df <- read.csv("../../../../Data/Keele & Titiunik 2015/WGAN_Epoch1k/focal_price.csv")
...
result$truth <- truth
write.csv(result, "../Results csv/wgan-rdrobust-price.csv", row.names = F)
